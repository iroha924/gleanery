...
review は 3 ラウンドまで。3 ラウンド目で直すべき指摘（REQ への対応漏れ、信頼境界と権限の穴、失敗時の扱いの欠落など上の問いに当たるもの）が出たら、直したうえで、承認を求める前に出た指摘・直した内容・棄却した理由を利用者に示して判断を求める。3 ラウンド目の直しは review を通っていない。
