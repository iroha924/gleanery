...
**The body is what `/sphica:harvest` reads** (with the review comments and commits; not the diff), and the decisions it picks from here
are what later searches find. Do not water it down with boilerplate.
